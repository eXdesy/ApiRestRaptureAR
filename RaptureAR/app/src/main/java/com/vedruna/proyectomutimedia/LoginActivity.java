...
public class LoginActivity extends AppCompatActivity {
    ...
    /**
     * Authenticate Firebase with Google Sign In credentials.
    ...
    /**
     * Update UI based on current user's authentication status.
    ...
    /**
     * Handle user login with local credentials.
     * @param view The view that triggers the login action.
     */
    ...
    /**
     * Validate user login with local credentials.
