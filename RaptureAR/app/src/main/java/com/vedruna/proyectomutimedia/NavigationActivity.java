...
/**
 * Actividad de navegación que gestiona la interfaz de usuario mediante BottomNavigationView.
 */
public class NavigationActivity extends AppCompatActivity {
    ...
    /**
     * Método que establece el listener para manejar eventos de selección en BottomNavigationView.
     */
